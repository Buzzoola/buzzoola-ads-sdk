...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Buzzoola/buzzoola-ads-sdk'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'alena.k' => 'alena.k@buzzoola.com' }
  s.source           = { :http => 'https://s-mobile-pub.buzzoola.com/buzzoola.sdk.ios.5.0.0.zip', :type => 'zip' }
  ...
  s.subspec 'BuzzoolaAdsSDKMyTarget' do |ss|
    ...
    ss.dependency 'myTargetSDK', '~> 5.46'
  end
