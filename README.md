...
```ruby
pod 'BuzzoolaAdsSDK', '3.3.0'
```
2. Если вы хотите использовать только рекламу Buzzoola: 
```ruby
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDK', '3.3.0'
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDKAnalytics', '3.3.0'
```
3. Если вы хотите использовать рекламу Buzzoola и ВК:
```ruby
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDK', '3.3.0'
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDKMyTarget', '3.3.0'
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDKAnalytics', '3.3.0'
```
...
Выберите File — Add Packages Dependencies. В поиск добавьте URL проекта, проверьте, что выбрана последняя версия 3.3.0 или задайте ее вручную, а после нажмите Add Package.
