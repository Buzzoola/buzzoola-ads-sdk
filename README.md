...
```ruby
pod 'BuzzoolaAdsSDK', '4.0.2'
pod 'BuzzoolaAdsSDKYandex', '4.0.2'
```
...
```ruby
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDK', '4.0.2'
pod 'BuzzoolaAdsSDK/BuzzoolaAdsSDKAnalytics', '4.0.2'
```
...
Выберите File — Add Packages Dependencies. В поиск добавьте URL проекта, проверьте, что выбрана последняя версия 4.0.2 или задайте ее вручную, а после нажмите Add Package.
